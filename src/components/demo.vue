  ...
  <!-- nav -->
      ...
      <div class="container-fluid d-flex">
            ...
            <ul class="navbar-nav d-flex justify-content-center">
              ...
              >
                ...
                <ul>
                  ...
                  >
                    <br />
                    <div class="d-flex-col bg-dark p-4">
                      <div class="row pt-0">
                        <div class="col-3">
                          <a href="./ProductList.html?id=Wireless_Earbuds">
                            <img
                              src="https://utioutll.sirv.com/Smart%20Watches/nav/20_11.png"
                              width="290px"
                              height="145px"
                          /></a>
                        </div>
                        <div class="col-3">
                          <a href="./ProductList.html?id=Wireless_Headphones">
                            <img
                              src="https://utioutll.sirv.com/Smart%20Watches/nav/20_1.png"
                              width="290px"
                              height="145px"
                          /></a>
                        </div>
                        <div class="col-3">
                          <a href="./ProductList.html?id=Smart_Watches">
                            <img
                              src="https://utioutll.sirv.com/Smart%20Watches/nav/20_2.png"
                              width="290px"
                              height="145px"
                          /></a>
                        </div>
                        <div class="col-3">
                          <a href="./ProductList.html?id=Wired_Earphones">
                            <img
                              src="https://utioutll.sirv.com/Smart%20Watches/nav/20_3.png"
                              width="290px"
                              height="145px"
                          /></a>
                        </div>
                      ...
                      <div class="row pt-4">
                        <div class="col-3">
                          <a href="./ProductList.html?id=Wireless_Speakers">
                            <img
                              src="https://utioutll.sirv.com/Smart%20Watches/nav/20_4.png"
                              width="290px"
                              height="145px"
                          /></a>
                        </div>
                        <div class="col-3">
                          <a href="./ProductList.html?id=Home_Audio">
                            <img
                              src="https://utioutll.sirv.com/Smart%20Watches/nav/20_5.png"
                              width="290px"
                              height="145px"
                          /></a>
                        </div>
                        <div class="col-3">
                          <a href="./ProductList.html?id=Mobile_Accessories">
                            <img
                              src="https://utioutll.sirv.com/Smart%20Watches/nav/20_6.png"
                              width="290px"
                              height="145px"
                          /></a>
                        </div>
                        <div class="col-3">
                          <a href="./ProductList.html?id=TRebel">
                            <img
                              src="https://utioutll.sirv.com/Smart%20Watches/nav/20_7.png"
                              width="290px"
                              height="145px"
                          /></a>
                        </div>
                      ...
                      <div class="row text-center pt-4">
                        <div class="col-4">
                          <a href="./ProductList.html?id=Limited_Edition">
                            <img
                              src="https://utioutll.sirv.com/Smart%20Watches/nav/20_8.png"
                              width="290px"
                              height="145px"
                          /></a>
                        </div>
                        <div class="col-4">
                          <a href="./ProductList.html?id=Misfit">
                            <img
                              src="https://utioutll.sirv.com/Smart%20Watches/nav/20_9.png"
                              width="290px"
                              height="145px"
                          /></a>
                        </div>
                        <div class="col-4">
                          <a href="./ProductList.html?id=Immortal_Gaming">
                            <img
                              src="https://utioutll.sirv.com/Smart%20Watches/nav/20_10.png"
                              width="290px"
                              height="145px"
                          /></a>
                        </div>
        ...
        <div class="order-md-4 order-1 p-2 bd-highlight">
          <div class="d-flex justify-content-start">
            ...
            <a href="./Cart.html" class="m-1 position-relative">
              <img
    ...
    <div>
          ...
          <div class="" id="login">
            ...
            <div class="form-group">
              <button
                type="submit"
                target="_self"
                v-on:click='location.href="./login.html"'
      ...
      <div id="closenav" v-on:Click.self="closenavb">
        <div class="vnav" id="vnav" style="background-color: rgb(0, 0, 0);width: 0%;">
          <ul class="p-0" style="list-style-type: none">
            <a>
              <!-- <div> -->
              <li id="shopin">
                <a
                   data-bs-toggle="collapse" href="#im" role="button" aria-expanded="false" aria-controls="collapseExample"
                >
                  <b
                    >Shop
                ...
                <div class="row  collapse" id="im">
                  ...
                  <div class="">
                    <img  src="https://utioutll.sirv.com/Smart%20Watches/nav/20_4.png"  width="200px"  height="100px"  />
                  </div>
                  <div class="">
                    <img
                      src="https://utioutll.sirv.com/Smart%20Watches/nav/20_5.png"
