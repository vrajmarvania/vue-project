...
var internal_models_IImageSourceModel = require('../../internal/models/IImageSourceModel.cjs');
var internal_models_IFetchSourceModel = require('../../internal/models/IFetchSourceModel.cjs');
...
var ConcatenateAction = /** @class */ (function (_super) {
    ...
    ConcatenateAction.fromJson = function (actionModel, transformationFromJson) {
        ...
        // @ts-ignore
        var sourceInstance;
        if (internal_models_IImageSourceModel.isIImageSourceModel(source)) {
            sourceInstance = qualifiers_source_sourceTypes_ImageSource.ImageSource.fromJson(source, transformationFromJson);
        }
        else if (internal_models_IFetchSourceModel.isIFetchSourceModel(source)) {
            sourceInstance = qualifiers_source_sourceTypes_FetchSource.FetchSource.fromJson(source, transformationFromJson);
        }
        else {
            sourceInstance = qualifiers_source_sourceTypes_VideoSource.VideoSource.fromJson(source, transformationFromJson);
        }
